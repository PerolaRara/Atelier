...
async function atualizarPedido() {
    ...
    const dados = {
        ...pedidos[index],
        // PRIORIDADE 1: Captura a data de venda editada (Retroativa)
    ...
    try {
        ...
        // PRIORIDADE 2: Reordenação cronológica automática após salvar
        // Mantém a ordem decrescente (mais recentes primeiro)
        pedidos.sort((a, b) => {
